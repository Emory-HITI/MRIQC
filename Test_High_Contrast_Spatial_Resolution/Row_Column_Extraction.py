...
def row_col_extraction(outline_image,localized_array,threshold_image,array_number):
    ...
    dup_localized_array=localized_array.copy()
   ...
   # print ("right_right_x value is",pixel_right_hor[1],"pixel y right right value",pixel_right_hor[0])            
    ...
    #cv2.rectangle(localized_array,(top_left_cord,high_upper_value),(top_left_cord+wid,high_upper_value+hei),(255,255,0),2)
   ...
   # print("last_column x value is",last_col[1],"last_Column y value is",last_col[0])
    ...
    #cv2.rectangle(dup_localized_array,(last_col_start,last_col_first_point),(last_col_start+wid6,last_col_first_point+hei6),(255,0,0),2)
    col_extend=[]
...
outline_image=cv2.imread(r"C:\Users\praroop_2\Desktop\QC_try\outline_image_arr1.png",0)
localized_array=cv2.imread(r"C:\Users\praroop_2\Desktop\QC_try\Bicubic_image_arr1.png",0)
threshold_image=cv2.imread(r"C:\Users\praroop_2\Desktop\QC_try\threshold_image_arr1.png",0)
array_number=1

row_col_extraction(outline_image,localized_array,threshold_image,array_number)
